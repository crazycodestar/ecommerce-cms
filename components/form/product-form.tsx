...
export function ProductForm({ onSubmit, form, children, disabled }: ProductFormProps) {
  ...
  const handleBasicSubmit = async (e: React.FormEvent) => {
    ...
    const basicFields = ['name', 'price', 'stock', 'images', 'isUnspecified', 'additionalInformation', "unitType"] as const;
